...
/**
 * This file contains tests that walks essay with correction helper questions through some attempts.
 *
...
require_once($CFG->dirroot . '/question/type/essayhelper/tests/helper.php');


/**
 * Unit tests for the essay with correction helper question type.
 *
 * @copyright 2018 Philippe Girard
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essayhelper_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_plain_text() {
        ...
        $helper = new qtype_essayhelper_test_helper();
        $q = $helper->make_essayhelper_question_plain();
    ...
    public function test_responsetemplate() {
        ...
        // Create an essay question.
        $q = test_question_maker::make_question('essayhelper', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_plain_attempt_on_last() {
        ...
        $question = $generator->create_question('essayhelper', 'plain', array('category' => $cat->id));
